...
***static*****flat****(*****modality:***[str](https://docs.python.org/3/library/stdtypes.html#str)**,*****slices:***[Sequence](https://docs.python.org/3/library/collections.abc.html#collections.abc.Sequence)***[***[slice](https://docs.python.org/3/library/functions.html#slice)***]*****)**
...
***class*****vllm.multimodal.inputs.****MultiModalKwargs****(*****data: ]]*****,***********,*****items:***[Sequence](https://docs.python.org/3/library/collections.abc.html#collections.abc.Sequence)***[***[MultiModalKwargsItem](https://docs.vllm.ai/en/latest/api/multimodal/inputs.html#vllm.multimodal.inputs.MultiModalKwargsItem)***] |***[None](https://docs.python.org/3/library/constants.html#None) ***=*** ***None*****)**
...
***static*****batch****(*****inputs_list:***[list](https://docs.python.org/3/library/stdtypes.html#list)***[***[vllm.multimodal.inputs.MultiModalKwargs](https://docs.vllm.ai/en/latest/api/multimodal/inputs.html#vllm.multimodal.inputs.MultiModalKwargs)***]*****)****→ ]]**
...
***static*****from_items****(*****items:***[Sequence](https://docs.python.org/3/library/collections.abc.html#collections.abc.Sequence)***[***[MultiModalKwargsItem](https://docs.vllm.ai/en/latest/api/multimodal/inputs.html#vllm.multimodal.inputs.MultiModalKwargsItem)***]*****)**
...
**mm_hashes*****:***[NotRequired](https://docs.python.org/3/library/typing.html#typing.NotRequired)***[MultiModalHashDict |***[None](https://docs.python.org/3/library/constants.html#None)***]***
...
**mm_placeholders*****:***[Mapping](https://docs.python.org/3/library/collections.abc.html#collections.abc.Mapping)***[***[str](https://docs.python.org/3/library/stdtypes.html#str)***,***[Sequence](https://docs.python.org/3/library/collections.abc.html#collections.abc.Sequence)***[***[PlaceholderRange](https://docs.vllm.ai/en/latest/api/multimodal/inputs.html#vllm.multimodal.inputs.PlaceholderRange)***]]***
...
**type*****:***[Literal](https://docs.python.org/3/library/typing.html#typing.Literal)***['multimodal']***
